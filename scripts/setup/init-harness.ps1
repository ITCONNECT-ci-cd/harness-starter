...
Write-Host ""
Write-Host "다음 단계:"
Write-Host "  1. BMAD 산출물 확인: _bmad-output/planning-artifacts/"
Write-Host "  2. BMAD 스킬 확인:   .agents/skills + .claude/skills"
Write-Host "  3. 프로젝트 초기화:  README.md의 새 프로젝트/기존 프로젝트 프롬프트 실행"
